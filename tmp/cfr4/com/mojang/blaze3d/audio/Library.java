...
public class Library {
    ...
    public void init(@Nullable String preferredDevice, DeviceList currentDevices, boolean useHrtf) {
        ...
        int streamingChannelCount = Mth.clamp((int)((int)Mth.sqrt((float)totalChannelCount)), (int)2, (int)8);
        int staticChannelCount = Mth.clamp((int)(totalChannelCount - streamingChannelCount), (int)8, (int)255);
