    ...
    private List<String> processImports(String source, Context context, String parentPath) {
        ...
        while (matcher.find()) {
            ...
            if (!Strings.isNullOrEmpty((String)contents)) {
                ...
                List<String> importedSources = this.processImports((String)contents, context, isRelative ? FileUtil.getFullResourcePath((String)importPath) : "");
                ...
                if (!StringUtil.isBlank((String)sourceBeforeImport)) {
            ...
            int lineCount = StringUtil.lineCount((String)source.substring(0, matcher.end(1)));
        ...
        if (!StringUtil.isBlank((String)remaining)) {
