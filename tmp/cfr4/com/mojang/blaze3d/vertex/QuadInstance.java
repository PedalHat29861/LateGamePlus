...
public class QuadInstance {
    ...
    public int getLightCoordsWithEmission(int vertex, int lightEmission) {
        return LightCoordsUtil.lightCoordsWithEmission((int)this.getLightCoords(vertex), (int)lightEmission);
    }
    ...
    public void multiplyColor(int color) {
        this.color0 = ARGB.multiply((int)this.color0, (int)color);
        this.color1 = ARGB.multiply((int)this.color1, (int)color);
        this.color2 = ARGB.multiply((int)this.color2, (int)color);
        this.color3 = ARGB.multiply((int)this.color3, (int)color);
    }

    public void scaleColor(float scale) {
        this.color0 = ARGB.scaleRGB((int)this.color0, (float)scale);
        this.color1 = ARGB.scaleRGB((int)this.color1, (float)scale);
        this.color2 = ARGB.scaleRGB((int)this.color2, (float)scale);
        this.color3 = ARGB.scaleRGB((int)this.color3, (float)scale);
    }
}
