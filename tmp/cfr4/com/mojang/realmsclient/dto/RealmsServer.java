...
implements ReflectionBasedSerialization {
    ...
    public static final Component WORLD_CLOSED_COMPONENT = Component.translatable((String)"mco.play.button.realm.closed");
    ...
    public static enum WorldType {
        ...
        private WorldType(String translationKey) {
            this.displayName = Component.translatable((String)(TRANSLATION_PREFIX + translationKey));
        }
