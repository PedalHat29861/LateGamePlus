...
public class RealmsTextureManager {
    ...
    private static Identifier getTexture(String id, String encodedImage) {
        ...
        Identifier textureId = Identifier.fromNamespaceAndPath((String)"realms", (String)("dynamic/" + id));
        Minecraft.getInstance().getTextureManager().register(textureId, new DynamicTexture(() -> ((Identifier)textureId).toString(), image));
