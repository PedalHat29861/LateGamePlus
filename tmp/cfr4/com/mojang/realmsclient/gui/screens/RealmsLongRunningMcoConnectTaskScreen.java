...
extends RealmsLongRunningMcoTaskScreen {
    ...
    public void init() {
        ...
        StringWidget region = new StringWidget((Component)Component.translatable((String)"mco.connect.region", (Object[])new Object[]{Component.translatable((String)this.serverAddress.regionData().region().translationKey)}), this.font);
