...
public class RealmsPopups {
    ...
    private static final Component INFO = Component.translatable((String)"mco.info").withColor(8226750);
    private static final Component WARNING = Component.translatable((String)"mco.warning").withColor(-65536);
