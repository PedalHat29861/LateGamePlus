...
extends RealmsScreen {
    ...
    private static final Component SELECT_BUTTON_NAME = Component.translatable((String)"mco.template.button.select");
    private static final Component TRAILER_BUTTON_NAME = Component.translatable((String)"mco.template.button.trailer");
    private static final Component PUBLISHER_BUTTON_NAME = Component.translatable((String)"mco.template.button.publisher");
        ...
        new Thread(this, "realms-template-fetcher"){
            ...
            public void run() {
                ...
                while (page != null) {
                    ...
                    page = (WorldTemplatePaginatedList)this.this$0.minecraft.submit(() -> {
        ...
        for (int i = 0; i < noTemplatesMessage.size(); ++i) {
            ...
            for (TextRenderingUtils.LineSegment segment : line.segments) {
                ...
                if (segment.isLink() && xm > startX && xm < endX && ym > lineY - 3 && ym < lineY + 8) {
                    graphics.setTooltipForNextFrame((Component)Component.literal((String)segment.getLinkUrl()), xm, ym);
    ...
    extends ObjectSelectionList.Entry<Entry> {
        private static final WidgetSprites WEBSITE_LINK_SPRITES = new WidgetSprites(Identifier.withDefaultNamespace((String)"icon/link"), Identifier.withDefaultNamespace((String)"icon/link_highlighted"));
        private static final WidgetSprites TRAILER_LINK_SPRITES = new WidgetSprites(Identifier.withDefaultNamespace((String)"icon/video_link"), Identifier.withDefaultNamespace((String)"icon/video_link_highlighted"));
        private static final Component PUBLISHER_LINK_TOOLTIP = Component.translatable((String)"mco.template.info.tooltip");
        private static final Component TRAILER_LINK_TOOLTIP = Component.translatable((String)"mco.template.trailer.tooltip");
        ...
        public Component getNarration() {
            Component entryName = CommonComponents.joinLines((Component[])new Component[]{Component.literal((String)this.template.name()), Component.translatable((String)"mco.template.select.narrate.authors", (Object[])new Object[]{this.template.author()}), Component.literal((String)this.template.recommendedPlayers()), Component.translatable((String)"mco.template.select.narrate.version", (Object[])new Object[]{this.template.version()})});
            return Component.translatable((String)"narrator.select", (Object[])new Object[]{entryName});
        }
    }
}
