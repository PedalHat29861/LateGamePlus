    ...
    extends ContainerObjectSelectionList.Entry<Entry> {
        ...
        public Entry(RealmsBackupScreen realmsBackupScreen, Backup backup) {
            ...
            if (!backup.changeList.isEmpty()) {
                this.changesButton = Button.builder(HAS_CHANGES_TOOLTIP, button -> realmsBackupScreen.minecraft.setScreen(new RealmsBackupInfoScreen(realmsBackupScreen, this.backup))).width(8 + realmsBackupScreen.font.width((FormattedText)HAS_CHANGES_TOOLTIP)).createNarration(this::narrationForBackupEntry).build();
        ...
        private void restoreClicked() {
            ...
            this.this$0.minecraft.setScreen(RealmsPopups.warningPopupScreen(this.this$0, (Component)popupMessage, popup -> {
