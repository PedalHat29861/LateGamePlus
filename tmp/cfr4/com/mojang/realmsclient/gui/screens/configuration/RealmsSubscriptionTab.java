...
implements RealmsConfigurationTab {
    ...
    static final Component TITLE = Component.translatable((String)"mco.configure.world.subscription.tab");
    ...
    private static final Component UNKNOWN = Component.translatable((String)"mco.configure.world.subscription.unknown");
    ...
    private void deleteRealm() {
        RealmsUtil.runAsync(client -> client.deleteRealm(this.serverData.id), RealmsUtil.openScreenAndLogOnFailure(this.configurationScreen::createErrorScreen, "Couldn't delete world")).thenRunAsync(() -> this.minecraft.setScreen(this.configurationScreen.getLastScreen()), (Executor)((Object)this.minecraft));
