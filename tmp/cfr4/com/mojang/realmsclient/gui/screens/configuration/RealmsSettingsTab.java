...
implements RealmsConfigurationTab {
    ...
    static final Component TITLE = Component.translatable((String)"mco.configure.world.settings.title");
    ...
    RealmsSettingsTab(RealmsConfigureWorldScreen configurationScreen, Minecraft minecraft, RealmsServer serverData, Map<RealmsRegion, ServiceQuality> regionServiceQuality) {
        ...
        this.closeOpenButton = helper.addChild(Button.builder((Component)Component.empty(), button -> {
            if (serverData.state == RealmsServer.State.OPEN) {
                minecraft.setScreen(RealmsPopups.customPopupScreen(configurationScreen, (Component)Component.translatable((String)"mco.configure.world.close.question.title"), (Component)Component.translatable((String)"mco.configure.world.close.question.line1"), popup -> {
                    this.save();
