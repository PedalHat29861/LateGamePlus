...
extends ToFloatFunction<C> {
    ...
    public static <C, I extends ToFloatFunction<C>> Codec<Spline<C, I>> createCodec(Codec<I> locationFunctionCodec) {
        ...
        Codec codec = RecordCodecBuilder.create(instance -> instance.group((App)Codec.FLOAT.fieldOf("location").forGetter(Serialized::location), (App)Codec.lazyInitialized((Supplier)mutableObject).fieldOf("value").forGetter(Serialized::value), (App)Codec.FLOAT.fieldOf("derivative").forGetter(Serialized::derivative)).apply((Applicative)instance, (location, value, derivative) -> new Serialized((float)location, value, (float)derivative)));
