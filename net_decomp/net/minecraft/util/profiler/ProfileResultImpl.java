...
implements ProfileResult {
    ...
    private static final Comparator<Map.Entry<String, CounterInfo>> COMPARATOR = Map.Entry.comparingByValue(Comparator.comparingLong(info -> info.totalTime)).reversed();
