...
implements FlightProfiler {
    ...
    private static final DateTimeFormatter DATE_TIME_FORMAT = new DateTimeFormatterBuilder().appendPattern("yyyy-MM-dd-HHmmss").toFormatter(Locale.ROOT).withZone(ZoneId.systemDefault());
    ...
    void addPeriodicEvents() {
        JfrProfiler.addPeriodicEvent(ClientFpsEvent.class, this.fpsEventRecorder);
        JfrProfiler.addPeriodicEvent(ServerTickTimeEvent.class, this.tickTimeEventRecorder);
        JfrProfiler.addPeriodicEvent(NetworkSummaryEvent.class, this.networkSummaryEventRecorder);
    }
    ...
    private void addListener() {
        FlightRecorder.addListener(new FlightRecorderListener(){
            final JfrListener listener = new JfrListener(() -> {
