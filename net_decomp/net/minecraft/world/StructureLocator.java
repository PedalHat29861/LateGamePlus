...
public class StructureLocator {
    ...
    private @Nullable Object2IntMap<Structure> collectStructuresAndReferences(NbtCompound nbt) {
        ...
        RegistryWrapper.Impl registry = this.registryManager.getOrThrow(RegistryKeys.STRUCTURE);
    ...
    private static /* synthetic */ void method_39839(Object2IntMap structure, Structure start, StructureStart structureStart) {
        if (structureStart.hasChildren()) {
            structure.put((Object)start, structureStart.getReferences());
        }
    }

    private static /* synthetic */ void method_68332(Registry registry, Object2IntMap object2IntMap, String string, NbtElement nbtElement) {
