...
RedstoneView,
BiomeAccess.Storage {
    public @Nullable Chunk getChunk(int var1, int var2, ChunkStatus var3, boolean var4);
    ...
    @Override
    default public @Nullable BlockView getChunkAsView(int chunkX, int chunkZ) {
    ...
    default public <T> RegistryWrapper<T> createCommandRegistryWrapper(RegistryKey<? extends Registry<? extends T>> registryRef) {
        RegistryWrapper.Impl registry = this.getRegistryManager().getOrThrow((RegistryKey)registryRef);
