...
public interface PlacementModifierType<P extends PlacementModifier> {
    ...
    public static final PlacementModifierType<FixedPlacementModifier> FIXED_PLACEMENT = PlacementModifierType.register("fixed_placement", FixedPlacementModifier.CODEC);
