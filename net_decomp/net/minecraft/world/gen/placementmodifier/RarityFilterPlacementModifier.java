...
extends AbstractConditionalPlacementModifier {
    public static final MapCodec<RarityFilterPlacementModifier> MODIFIER_CODEC = Codecs.POSITIVE_INT.fieldOf("chance").xmap(RarityFilterPlacementModifier::new, placementModifier -> placementModifier.chance);
