...
extends AbstractCountPlacementModifier {
    public static final MapCodec<CountPlacementModifier> MODIFIER_CODEC = IntProvider.createValidatingCodec(0, 256).fieldOf("count").xmap(CountPlacementModifier::new, placementModifier -> placementModifier.count);
