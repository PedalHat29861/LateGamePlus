...
extends PlacementModifier {
    public static final MapCodec<HeightmapPlacementModifier> MODIFIER_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Heightmap.Type.CODEC.fieldOf("heightmap").forGetter(placementModifier -> placementModifier.heightmap)).apply((Applicative)instance, HeightmapPlacementModifier::new));
