...
extends Structure {
    public static final MapCodec<NetherFossilStructure> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(NetherFossilStructure.configCodecBuilder(instance), (App)HeightProvider.CODEC.fieldOf("height").forGetter(structure -> structure.height)).apply((Applicative)instance, NetherFossilStructure::new));
