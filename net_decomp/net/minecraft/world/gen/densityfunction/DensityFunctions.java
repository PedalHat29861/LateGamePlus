...
public class DensityFunctions {
    ...
    private static void registerSlopedCheeseFunction(Registerable<DensityFunction> densityFunctionRegisterable, RegistryEntryLookup<DensityFunction> densityFunctionLookup, DensityFunction jaggedNoise, RegistryEntry<DensityFunction> continents, RegistryEntry<DensityFunction> erosion, RegistryKey<DensityFunction> offsetKey, RegistryKey<DensityFunction> factorKey, RegistryKey<DensityFunction> jaggednessKey, RegistryKey<DensityFunction> depthKey, RegistryKey<DensityFunction> slopedCheeseKey, boolean amplified) {
        ...
        DensityFunction densityFunction3 = DensityFunctions.registerAndGetHolder(densityFunctionRegisterable, depthKey, DensityFunctions.applyHeightGradient(densityFunction));
    ...
    protected static NoiseRouter createSurfaceNoiseRouter(RegistryEntryLookup<DensityFunction> densityFunctionLookup, RegistryEntryLookup<DoublePerlinNoiseSampler.NoiseParameters> noiseParametersLookup, boolean largeBiomes, boolean amplified) {
        ...
        DensityFunction densityFunction9 = DensityFunctions.entryHolder(densityFunctionLookup, largeBiomes ? OFFSET_OVERWORLD_LARGE_BIOME : (amplified ? OFFSET_OVERWORLD_AMPLIFIED : OFFSET_OVERWORLD));
        DensityFunction densityFunction10 = DensityFunctions.entryHolder(densityFunctionLookup, largeBiomes ? FACTOR_OVERWORLD_LARGE_BIOME : (amplified ? FACTOR_OVERWORLD_AMPLIFIED : FACTOR_OVERWORLD));
        DensityFunction densityFunction11 = DensityFunctions.entryHolder(densityFunctionLookup, largeBiomes ? DEPTH_OVERWORLD_LARGE_BIOME : (amplified ? DEPTH_OVERWORLD_AMPLIFIED : DEPTH_OVERWORLD));
        DensityFunction densityFunction12 = DensityFunctions.findTopSurface(densityFunction9, densityFunction10, amplified);
        DensityFunction densityFunction13 = DensityFunctions.entryHolder(densityFunctionLookup, largeBiomes ? SLOPED_CHEESE_OVERWORLD_LARGE_BIOME : (amplified ? SLOPED_CHEESE_OVERWORLD_AMPLIFIED : SLOPED_CHEESE_OVERWORLD));
        DensityFunction densityFunction14 = DensityFunctionTypes.min(densityFunction13, DensityFunctionTypes.mul(DensityFunctionTypes.constant(5.0), DensityFunctions.entryHolder(densityFunctionLookup, CAVES_ENTRANCES_OVERWORLD)));
        DensityFunction densityFunction15 = DensityFunctionTypes.rangeChoice(densityFunction13, -1000000.0, 1.5625, densityFunction14, DensityFunctions.createCavesFunction(densityFunctionLookup, noiseParametersLookup, densityFunction13));
        DensityFunction densityFunction16 = DensityFunctionTypes.min(DensityFunctions.applyBlendDensity(DensityFunctions.applySurfaceSlides(amplified, densityFunction15)), DensityFunctions.entryHolder(densityFunctionLookup, CAVES_NOODLE_OVERWORLD));
        DensityFunction densityFunction17 = DensityFunctions.entryHolder(densityFunctionLookup, Y);
        ...
        DensityFunction densityFunction18 = DensityFunctions.verticalRangeChoice(densityFunction17, DensityFunctionTypes.noise(noiseParametersLookup.getOrThrow(NoiseParametersKeys.ORE_VEININESS), 1.5, 1.5), i, j, 0);
        float f = 4.0f;
        DensityFunction densityFunction19 = DensityFunctions.verticalRangeChoice(densityFunction17, DensityFunctionTypes.noise(noiseParametersLookup.getOrThrow(NoiseParametersKeys.ORE_VEIN_A), 4.0, 4.0), i, j, 0).abs();
        DensityFunction densityFunction20 = DensityFunctions.verticalRangeChoice(densityFunction17, DensityFunctionTypes.noise(noiseParametersLookup.getOrThrow(NoiseParametersKeys.ORE_VEIN_B), 4.0, 4.0), i, j, 0).abs();
        DensityFunction densityFunction21 = DensityFunctionTypes.add(DensityFunctionTypes.constant(-0.08f), DensityFunctionTypes.max(densityFunction19, densityFunction20));
    ...
    private static DensityFunction findTopSurface(DensityFunction offset, DensityFunction factor, boolean amplified) {
        ...
        DensityFunction densityFunction3 = DensityFunctions.estimateUpperBound(DensityFunctionTypes.add(DensityFunctionTypes.mul(DensityFunctionTypes.constant(0.2734375), densityFunction.invert()), DensityFunctionTypes.mul(DensityFunctionTypes.constant(-1.0), densityFunction2)), 1.5, -1.5, -64.0, 320.0);
        densityFunction3 = densityFunction3.clamp(-40.0, 320.0);
        DensityFunction densityFunction4 = DensityFunctionTypes.add(DensityFunctions.applySurfaceSlides(amplified, DensityFunctionTypes.add(DensityFunctions.createInitialDensityFunction(densityFunction, DensityFunctions.applyHeightGradient(densityFunction2)), DensityFunctionTypes.constant(-0.703125)).clamp(-64.0, 64.0)), DensityFunctionTypes.constant(-0.390625));
