...
extends ChunkGenerator {
    public static final MapCodec<DebugChunkGenerator> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(RegistryOps.getEntryCodec(BiomeKeys.PLAINS)).apply((Applicative)instance, instance.stable(DebugChunkGenerator::new)));
