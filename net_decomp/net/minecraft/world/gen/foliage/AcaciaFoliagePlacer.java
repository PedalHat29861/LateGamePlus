...
extends FoliagePlacer {
    public static final MapCodec<AcaciaFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec(instance -> AcaciaFoliagePlacer.fillFoliagePlacerFields(instance).apply((Applicative)instance, AcaciaFoliagePlacer::new));
