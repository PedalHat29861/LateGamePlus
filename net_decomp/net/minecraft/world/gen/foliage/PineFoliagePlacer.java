...
extends FoliagePlacer {
    public static final MapCodec<PineFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec(instance -> PineFoliagePlacer.fillFoliagePlacerFields(instance).and((App)IntProvider.createValidatingCodec(0, 24).fieldOf("height").forGetter(placer -> placer.height)).apply((Applicative)instance, PineFoliagePlacer::new));
