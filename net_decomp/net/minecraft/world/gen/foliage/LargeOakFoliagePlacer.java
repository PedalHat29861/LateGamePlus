...
extends BlobFoliagePlacer {
    public static final MapCodec<LargeOakFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec(instance -> LargeOakFoliagePlacer.createCodec(instance).apply((Applicative)instance, LargeOakFoliagePlacer::new));
