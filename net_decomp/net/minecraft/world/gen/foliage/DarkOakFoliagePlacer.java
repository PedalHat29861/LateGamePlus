...
extends FoliagePlacer {
    public static final MapCodec<DarkOakFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec(instance -> DarkOakFoliagePlacer.fillFoliagePlacerFields(instance).apply((Applicative)instance, DarkOakFoliagePlacer::new));
