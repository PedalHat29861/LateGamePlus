...
extends TrunkPlacer {
    public static final MapCodec<GiantTrunkPlacer> CODEC = RecordCodecBuilder.mapCodec(instance -> GiantTrunkPlacer.fillTrunkPlacerFields(instance).apply((Applicative)instance, GiantTrunkPlacer::new));
