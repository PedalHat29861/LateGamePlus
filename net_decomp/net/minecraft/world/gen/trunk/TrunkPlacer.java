...
public abstract class TrunkPlacer {
    ...
    protected boolean getAndSetState(TestableWorld world, BiConsumer<BlockPos, BlockState> replacer, Random random, BlockPos pos, TreeFeatureConfig config, Function<BlockState, BlockState> mapper) {
        if (this.canReplace(world, pos)) {
            replacer.accept(pos, mapper.apply(config.trunkProvider.get(random, pos)));
            return true;
        }
        return false;
    }
