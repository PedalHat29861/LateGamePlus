...
extends TrunkPlacer {
    public static final MapCodec<StraightTrunkPlacer> CODEC = RecordCodecBuilder.mapCodec(instance -> StraightTrunkPlacer.fillTrunkPlacerFields(instance).apply((Applicative)instance, StraightTrunkPlacer::new));
