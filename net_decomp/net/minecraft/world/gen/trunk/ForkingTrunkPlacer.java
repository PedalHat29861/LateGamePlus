...
extends TrunkPlacer {
    public static final MapCodec<ForkingTrunkPlacer> CODEC = RecordCodecBuilder.mapCodec(instance -> ForkingTrunkPlacer.fillTrunkPlacerFields(instance).apply((Applicative)instance, ForkingTrunkPlacer::new));
