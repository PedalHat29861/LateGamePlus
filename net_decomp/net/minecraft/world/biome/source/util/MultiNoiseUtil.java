...
public class MultiNoiseUtil {
    ...
    extends Record {
        ...
        public NoiseValuePoint(long temperatureNoise, long humidityNoise, long continentalnessNoise, long erosionNoise, long depth, long weirdnessNoise) {
    ...
    protected static final class SearchTree<T> {
        ...
        private final ThreadLocal<@Nullable TreeLeafNode<T>> previousResultNode = new ThreadLocal();
