...
public final class VanillaBiomeParameters {
    ...
    private void writeDebug(Consumer<Pair<MultiNoiseUtil.NoiseHypercube, RegistryKey<Biome>>> parameters) {
        Spline spline2;
        RegistryWrapper.WrapperLookup wrapperLookup = new RegistryBuilder().addRegistry(RegistryKeys.DENSITY_FUNCTION, DensityFunctions::bootstrap).addRegistry(RegistryKeys.NOISE_PARAMETERS, BuiltinNoiseParameters::bootstrap).createWrapperLookup(DynamicRegistryManager.of(Registries.REGISTRIES));
