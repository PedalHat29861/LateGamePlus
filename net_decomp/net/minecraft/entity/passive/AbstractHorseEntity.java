...
JumpingMount {
    ...
    protected void walkToParent(ServerWorld world) {
        ...
        if (this.isBred() && this.isBaby() && !this.isEatingGrass() && (livingEntity = world.getClosestEntity(AbstractHorseEntity.class, PARENT_HORSE_PREDICATE, (LivingEntity)this, this.getX(), this.getY(), this.getZ(), this.getBoundingBox().expand(16.0))) != null && this.squaredDistanceTo(livingEntity) > 4.0) {
