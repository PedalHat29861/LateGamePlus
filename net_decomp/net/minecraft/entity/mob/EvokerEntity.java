...
extends SpellcastingIllagerEntity {
    ...
    extends SpellcastingIllagerEntity.CastSpellGoal {
        ...
        public boolean canStart() {
            ...
            List<SheepEntity> list = serverWorld.getTargets(SheepEntity.class, this.convertibleSheepPredicate, EvokerEntity.this, EvokerEntity.this.getBoundingBox().expand(16.0, 4.0, 16.0));
            if (list.isEmpty()) {
                return false;
            }
