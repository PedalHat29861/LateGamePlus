...
public class TradeOffers {
    ...
    public static final Map<RegistryKey<VillagerProfession>, Int2ObjectMap<Factory[]>> PROFESSION_TO_LEVELED_TRADE = Util.make(Maps.newHashMap(), map -> {
    ...
    record TypedWrapperFactory(Map<RegistryKey<VillagerType>, Factory> typeToFactory) implements Factory
    {
        @SafeVarargs
        ...
        public @Nullable TradeOffer create(ServerWorld world, Entity entity, Random random) {
            if (entity instanceof VillagerDataContainer) {
                ...
                return factory.create(world, entity, random);
            }
            return null;
        }
    ...
    implements Factory {
        ...
        public TradeOffer create(ServerWorld world, Entity entity, Random random) {
            int l;
            ItemStack itemStack;
            Optional optional = world.getRegistryManager().getOrThrow(RegistryKeys.ENCHANTMENT).getRandomEntry(this.possibleEnchantments, random);
            if (!optional.isEmpty()) {
    ...
    public static interface Factory {
        public @Nullable TradeOffer create(ServerWorld var1, Entity var2, Random var3);
    }
    ...
    implements Factory {
        ...
        public TradeOffer create(ServerWorld world, Entity entity, Random random) {
            ...
            List list = Registries.POTION.streamEntries().filter(entry -> !((Potion)entry.value()).getEffects().isEmpty() && world.getBrewingRecipeRegistry().isBrewable((RegistryEntry<Potion>)entry)).collect(Collectors.toList());
